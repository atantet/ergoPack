...
biorthonormal..."
	...
	if (getForwardEigenvectors)
	  {
	    std::cout << "Writing forward eigenvalues to " << EigValForwardFileName
		      << " and eigenvectors to " << EigVecForwardFileName
		      << std::endl;
	...
	if (getBackwardEigenvectors)
	  {
	    std::cout << "Writing backward eigenvalues to " << EigValBackwardFileName
		      << " and eigenvectors to " << EigVecBackwardFileName
		      << std::endl;
